...
export class Assembler {
  ...
  static imm(val, labels, currentAddr) {
  ...
  static encodeU(opcode, rd, imm) {
    return (opcode & 0x7f) | ((rd & 0x1f) << 7) | (imm & 0xfffff000);
  }

  static encodeJ(opcode, rd, imm) {
